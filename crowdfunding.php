                        ...
                        <div class="form-box">
                            <form action="#">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center mt-4">
                                        <a href="https://www1.caixabank.es/apl/donativos/detalle_es.html?DON_codigoCausa=737" class="btn btn-primary effect btn-md link_trgt" style="width: 80%;"><i class="fa fa-2x fa-credit-card" aria-hidden="true"></i> <span class="lang_con_tarjeta">Amb targeta</span></a>
                                    </div>
                                    <div class="col-md-12 text-center mt-4">
